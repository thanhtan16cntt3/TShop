...
@push('breadcrumb')
    ...
    <li class="breadcrumb-item" aria-current="page"><a href="{{ route('tags.index') }}" >Post tags</a></li>
    <li class="breadcrumb-item active" aria-current="page">Create post tag</li>
@endpush
@section('content-main')
    <div class="card shadow mb-4">
        <div class="card-header">
            <h4 class="font-weight-bold text-primary">Add post tag</h4>
        </div>
        <div class="card-body">
